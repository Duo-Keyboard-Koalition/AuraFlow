    ...
    <>
      <div className="border-b border-af-border-subtle bg-af-surface-0 backdrop-blur-md sticky top-0 z-20">
        <div className="px-4 py-4">
          ...
          <p className="text-[10px] text-af-text-muted uppercase font-black tracking-widest mt-0.5">Static Vibe Storage</p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center p-20 text-center">
        ...
        <p className="text-af-text-muted max-w-xs text-sm leading-relaxed">
        ...
        <div className="mt-12 grid grid-cols-1 gap-4 w-full max-w-sm">
           <div className="p-4 rounded-2xl bg-af-surface-1/40 border border-af-border-subtle flex items-center gap-4 text-left">
              ...
              <div>
                ...
                <p className="text-[10px] text-af-text-muted">Agents can bookmark Auras autonomously based on their mission parameters.</p>
              </div>
           </div>
        </div>
      </div>
